...
//metodos get/set para pegar e colocar valores nas variaveis
	public String getId() {
		return id;
	}
    ...
    public String toString() { //Metodo para printar da forma correta os elementos da classe na tela
    ...
    public Musica() //Construtor para setar valores iniciais e previnir erros -> ao montar sem o construtor tive problemas para manejar os dados
    {
...
public class Mainclass //Classe principal do programa
{
   
public static String pegaNomeMusica(String pit) // pega o nome dos artistas separando o seu espacamento na string e coletando-os individualmente
{
...
public static String retornaFim(String pit) //Corta a string em uma parte desejada para facilitar a filtragem e evitar conflitos de caracteres
{
...
public static boolean verificaAspas(String pit) // verifica a existencia de aspas na string selecionada
{
...
public static String[] spliTvirgula(String pit)// da um split na virgula
{
...
public static String pegaMusicanome (String pit) //separa o nome da musica e o capta
{
...
public static String[] pega3primeiros(String pit)//puxa os 3 primeiros elementos da string
{
    int fim = pit.indexOf("[");
...
public static List<String> pegaNome(String pit)//adiciona os artistas a lista 
{
...
public static String[] semNomenoMeio(String linha) { // Pega todos os elementos pos nomes dos artistas, tirando o nome da musica
...
public static Musica colocaNaClasse(String pit)//Coloca todos elementos em suas respectivas variaveis dentro da classe
{
...
return musica;
    ...
    public static void main(String[] args) throws Exception {
		...
		try { // try catch para pegar os erros
			...
			while ((arquivo = conteudoCsv.readLine()) != null) { // leitura do arquivo de texto
				for (y = 0; y < x; y++) {
                    if(arquivo.contains(pubin[y])) //verifica a existencia do ID antes de captar
                    {
			...
			for (p = 0; p < x ; p = p + 1) {
				for (o = 0; o < y ; o = o + 1) {
					if (dedo[o].contains(pubin[p])) { //apos organizar a puxar somente os desejados eles sao printados
						System.out.println(dedo[o]);
					}
				}
			} 
		} catch (Exception e) {
